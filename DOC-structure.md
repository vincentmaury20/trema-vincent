...
-   ajouter un sommaire (table des matières) à ce fichier,
-   lier ce document depuis le `README.md`,
-   ou générer automatiquement une liste complète des fichiers avec une courte description.
